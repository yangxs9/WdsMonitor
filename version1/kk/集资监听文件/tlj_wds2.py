...
while True:
    ...
    msg = ''
    if tljWds.isChanged:
        for user in tljWds.addedUserInfo:
            msg = msg + user + ' 刚刚支持了Liga' + tljWds.addedUserInfo[user][3:] + '，'
        msg += '感谢大家的支持！'
    if lsnWds.isChanged:
        msg = msg + '小树集资刚刚增长了' + str(round(lsnWds.addedAmount, 2)) + '元。'
    ...
    if lsnWds.amount < tljWds.amount:
        ...
        msg += '暂时打平。'
    msg += '北广对抗赛已经开始，为了让Liga远离豆汁的威胁，大家加油集资吧！微打赏链接：https://wds.modian.com/show_weidashang_pro/4558#1'
