...
def sendMsg(mainWds, other1, other2, other3):
    ...
    msg += mainWds.name + '：' 
    msg += str(mainWds.amount) + '\n'
    
    msg += other1.name + '+' + other2.name + '+' + other3.name + '：' 
    msg += str(other1.amount) + '+' + str(other2.amount) + '+' + str(other3.amount) + '=' + str(round(other1.amount + other2.amount + other3.amount, 2)) + '\n'
